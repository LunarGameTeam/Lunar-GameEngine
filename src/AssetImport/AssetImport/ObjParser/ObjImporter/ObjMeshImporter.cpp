...
namespace luna::asset
{
	void LObjImporterMesh::SetAttributeById(
		...
		asset::LImportNodeDataMesh* nowOutData
	...
	void LObjImporterMesh::ParsingDataImpl(const LObjDataBase* objDataInput, asset::LImportScene& outputScene)
	{
		...
		node_value.mNodeData.insert(std::pair<asset::LImportNodeDataType, size_t>(asset::LImportNodeDataType::ImportDataMesh, node_value.mIndex));
