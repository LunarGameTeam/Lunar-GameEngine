...
DXGI_FORMAT RENDER_API GetGraphicFormat(const RHITextureFormat& graphic_format)
{
	...
	case RHITextureFormat::R8G8B8A8_TYPELESS:
...
RHITextureFormat RENDER_API GetGraphicFormatFromDx(const DXGI_FORMAT& graphic_format)
{
	...
	case DXGI_FORMAT_R16G16B16A16_TYPELESS:
		return RHITextureFormat::R16G16B16A16_TYPELESS;
	case DXGI_FORMAT_R16G16B16A16_FLOAT:
		return RHITextureFormat::R16G16B16A16_FLOAT;
	case DXGI_FORMAT_R16G16B16A16_UNORM:
		return RHITextureFormat::R16G16B16A16_UNORM;
	case DXGI_FORMAT_R16G16B16A16_UINT:
		return RHITextureFormat::R16G16B16A16_UINT;
	...
	case DXGI_FORMAT_R8G8B8A8_TYPELESS:
		return RHITextureFormat::R8G8B8A8_TYPELESS;
	case DXGI_FORMAT_R8G8B8A8_UNORM:
		return RHITextureFormat::R8G8B8A8_UNORM;
	case DXGI_FORMAT_R8G8B8A8_UNORM_SRGB:
		return RHITextureFormat::R8G8B8A8_UNORM_SRGB;
	case DXGI_FORMAT_R8G8B8A8_UINT:
		return RHITextureFormat::R8G8B8A8_UINT;
	case DXGI_FORMAT_R8G8B8A8_SNORM:
		return RHITextureFormat::R8G8B8A8_SNORM;
	case DXGI_FORMAT_R8G8B8A8_SINT:
		return RHITextureFormat::R8G8B8A8_SINT;
...
D3D12_PRIMITIVE_TOPOLOGY_TYPE GetTypologyType(
...
D3D12_GRAPHICS_PIPELINE_STATE_DESC GetPipelineDesc(const RHIPipelineStateGraphDrawDesc& pipeline_desc, const RenderPassDesc pass_desc)
{
		...
		render_target_index)
	{
		...
		desc_out.RTVFormats[render_target_index] = GetGraphicFormat(pass_desc.mColorView[render_target_index]->mBindResource->GetDesc().Format);
	}
	...
	{
		desc_out.RTVFormats[rtv_index] = GetGraphicFormat(pass_desc.mColorView[rtv_index]->mBindResource->GetDesc().Format);
	}
