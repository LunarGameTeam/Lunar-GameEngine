#pragma once
#include "fbx_scene_loader.h"
#include "fbx_mesh_loader.h"
#include "fbx_skeleton_loader.h"
#include "fbx_animation_loader.h"
#include "fbx_material_loader.h"
#include "fbx_camera_loader.h"
namespace luna::lfbx
{
	...
	std::shared_ptr<LFbxDataBase> LFbxLoaderFactory::LoadFbxData(LFbxDataType type, const LVector<LFbxNodeBase>& sceneNodes, fbxsdk::FbxNode* pNode, FbxManager* pManager)
	{
